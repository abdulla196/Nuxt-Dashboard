...
<v-container>
    ...
    <h3>Basic Information</h3>
        ...
        <h3 class="text-h5 text-center mb-3"><span  class="infomaid"> Number Of Users Reviews</span><br/><span  class="details"> {{items.reviews.length}}</span>  </h3></div>
                <div class="col-md-4 col-12"><h3 class="text-h5 text-center mb-3"> <span  class="infomaid"> number Of Users Favourite</span> <p class="details">{{allFavouriteList.num_user_fav}}</p></h3></div>
            </v-row>
